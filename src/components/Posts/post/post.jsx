...
import {changeID,deletePost,likePost} from '../action'
...
const Post = ({post}) => {
     ...
     const user = useSelector(state => state.auth.authData ? state.auth.authData : undefined)
    ...
    return (
       <Card className={classes.card} raised elevation={6}>
          <ButtonBase component="span" name="test" className={classes.cardAction} onClick={openPost}>
               ...
               <CardContent>
                    <Typography variant="body2" color="textSecondary" className={classes.customPara}  component="p">{post.message}</Typography>
               </CardContent>
          </ButtonBase>
           <CardActions>
